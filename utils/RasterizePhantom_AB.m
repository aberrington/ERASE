...
% Modified by Adam Berrington, University of Nottingham
% 22/11/2019

function [im,sens_rast] = RasterizePhantom_AB(phantom,res,s,MATLAB_SL_CONSISTENT)
%Input check
...
elseif (isnumeric(s) && (size(s,1) == res(1)) && (size(s,2) == res(2))) % APB added this condition 08/15/2018
    sens_rast = s;
elseif isstruct(s)
    sens_rast = zeros(res);
